...
casts_df = spark.table("02_silver.warcraftlogs.events_casts")
healing_summary_df = spark.table("02_silver.warcraftlogs.tables_healing_summary")
abilities_df = spark.table("02_silver.warcraftlogs.tables_player_abilities")
display(casts_df)
display(healing_summary_df)
