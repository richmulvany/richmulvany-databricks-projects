...
valid_df.write.mode("append").saveAsTable("02_silver.warcraftlogs.f_player_details")
quarantine_df.write.mode("append").saveAsTable("02_silver.dq_monitoring.warcraftlogs_quarantine_player_details")
