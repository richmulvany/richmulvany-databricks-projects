...
tables = {
    "game_data_abilities": spark.read.table("02_silver.staging.warcraftlogs_game_data_abilities"),
    "game_data_classes": spark.read.table("02_silver.staging.warcraftlogs_game_data_classes"),
    "game_data_items": spark.read.table("02_silver.staging.warcraftlogs_game_data_items"),
    "game_data_zones": spark.read.table("02_silver.staging.warcraftlogs_game_data_zones")
}
...
for name, df in tables.items():
    ...
    # Save
    valid_df.write.mode("append").saveAsTable(f"02_silver.warcraftlogs.d_{name}")
